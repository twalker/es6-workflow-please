...
System.register("app/hello-cjs", [], true, function(require, exports, module) {
  ...
  var obj = {say: function speak(msg) {
...
System.register("app/backbone-extended", ["jquery", "backbone"], function($__export) {
  "use strict";
...
System.register("app/hello-backbone", ["./backbone-extended"], function($__export) {
  "use strict";
...
System.register("app/main", ["./hello-es6", "./hello-amd", "./hello-cjs", "./hello-backbone", "mustache", "./template.text!text"], function($__export) {
  "use strict";
